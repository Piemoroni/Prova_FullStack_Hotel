...
function listarQuartos() {
    ...
    quartos.forEach(quarto => {
        ...
        card.innerHTML = `
            ...
            <div class="botoes">
                <button class="btnReservas" onclick="abrirReservas(${quarto.id})"> Ver Reservas </button>
                <button class="btnExcluir" onclick="excluirQuarto(${quarto.id})"> Excluir </button>
            </div>
        `;
...
// Novo quarto
document.querySelector("#formQuarto").addEventListener("submit", function (e) {
...
// Mostra as reservas do quarto selecionado
    ...
    reservas.forEach(reserva => {
        listaReservas.innerHTML += `
            <tr>
                ...
                <td>
                    <button class="btnExcluir" onclick="excluirReserva(${reserva.id})"> Excluir </button>
                </td>
            </tr>
        `;
    });
        ...
        .then(data => {
            ...
            data.forEach(reserva => {
                ...
                card.innerHTML = `
                    ...
                    <p> <b>Hóspede:</b> <br> ${reserva.hospede} </p>
                    <p> <b>Entrada:</b> <br> ${new Date(reserva.data_entrada).toLocaleDateString("pt-BR")}</p>
                    <p> <b>Saída:</b> <br> ${new Date(reserva.data_saida).toLocaleDateString("pt-BR")}</p>
                    <p> <b>Quarto:</b> ${reserva.quarto.numero} </p>
                    <button class="btnExcluir" onclick="excluirReserva(${reserva.id})"> Excluir </button>
                `;
                container.appendChild(card);
            });
